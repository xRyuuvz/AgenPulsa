...
class InternetBulanan extends StatelessWidget {
  const InternetBulanan({super.key});

  @override
  Widget build(BuildContext context) {
    TextEditingController tfPhoneNumberController = TextEditingController();
    List<Map<String, String>> list = [
      {'title': 'Pembayaran Tagihan Biznet', 'expired': '7', 'price': '0'},
      {'title': 'Pembayaran Tagihan CBN', 'expired': '7', 'price': '0'},
      {'title': 'Pembayaran Tagihan FirstMedia', 'expired': '7', 'price': '0'},
      {'title': 'Pembayaran Tagihan iConnect PLN', 'expired': '7', 'price': '0'},
      {'title': 'Pembayaran Tagihan MyRepublic', 'expired': '7', 'price': '0'},
      {'title': 'Pembayaran Tagihan Indihome', 'expired': '7', 'price': '0'},
    ];
